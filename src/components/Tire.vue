<script setup>
// props 외부에서 들어오는 데이터(파라미터st)
// 외부에서 값을 받아 사용하고 싶으면 이걸 써
const props = defineProps({
  color: String, // 타입 지정 |무조건 지정할 것. 안하면 오류
});

//color라는 속성으로 데이터를 받을 수 있다.
// {{}} template(HTML)안에서 상수 혹은 변수에 담겨있는 값(value)를 표시할 때 사용
</script>
